/* -- Device_Handsfree2.h -- MD0.1.1 --------------------------------------------------------------------*/
#ifdef HANDSFREE_ACTIVE
  #ifndef DEVICE_HANDSFREE2_H
    #define DEVICE_HANDSFREE2_H
    #include "Arduino.h"
    ...
    static device_field_data_t bluetti_device_state[] =
      {
        ...
        //{INTERNAL_POWER_ONE,        0x00, 0x49,  1, 0, 0,             UINT_FIELD},    //  73    2    8  0x49
        ...
        //{    ADR_0x008F_UINT,          0x00, 0x8F,  1, 0, 0,             UINT_FIELD},    // 112    2   74  0x8F
                                                                          // poll 6 end
        /*Page 0x02 */
        //{    ADR_0x0100_UINT,          0x01, 0x00,  1, 0, 0,             UINT_FIELD},    // 100    2   20  0x64
        //{    ADR_0x0101_UINT,          0x01, 0x01,  1, 0, 0,             UINT_FIELD},    // 100    2   20  0x64
        //{    ADR_0x0102_UINT,          0x01, 0x02,  1, 0, 0,             UINT_FIELD},    // 100    2   20  0x64
        //{    ADR_0x0103_UINT,          0x01, 0x03,  1, 0, 0,             UINT_FIELD},    // 100    2   20  0x64
        //{    ADR_0x0104_UINT,          0x01, 0x04,  1, 0, 0,             UINT_FIELD},    // 100    2   20  0x64
        //{    ADR_0x0105_UINT,          0x01, 0x05,  1, 0, 0,             UINT_FIELD},    // 100    2   20  0x64
        //{    ADR_0x0106_UINT,          0x01, 0x06,  1, 0, 0,             UINT_FIELD},    // 100    2   20  0x64
        //{    ADR_0x0107_UINT,          0x01, 0x07,  1, 0, 0,             UINT_FIELD},    // 100    2   20  0x64
        //{    ADR_0x0108_UINT,          0x01, 0x08,  1, 0, 0,             UINT_FIELD},    // 100    2   20  0x64
        //{    ADR_0x0109_UINT,          0x01, 0x09,  1, 0, 0,             UINT_FIELD},    // 100    2   20  0x64
        //{    ADR_0x010A_UINT,          0x01, 0x0A,  1, 0, 0,             UINT_FIELD},    // 100    2   20  0x64
        //{    ADR_0x010B_UINT,          0x01, 0x0B,  1, 0, 0,             UINT_FIELD},    // 100    2   20  0x64
        //{    ADR_0x010C_UINT,          0x01, 0x0C,  1, 0, 0,             UINT_FIELD},    // 100    2   20  0x64
        //{    ADR_0x010D_UINT,          0x01, 0x0D,  1, 0, 0,             UINT_FIELD},    // 100    2   20  0x64
        //{    ADR_0x010E_UINT,          0x01, 0x0E,  1, 0, 0,             UINT_FIELD},    // 100    2   20  0x64
        //{    ADR_0x010F_UINT,          0x01, 0x0F,  1, 0, 0,             UINT_FIELD},    // 100    2   20  0x64
        //{    ADR_0x0110_UINT,          0x01, 0x10,  1, 0, 0,             UINT_FIELD},    // 100    2   20  0x64
        //{    ADR_0x0111_UINT,          0x01, 0x11,  1, 0, 0,             UINT_FIELD},    // 100    2   20  0x64
        //{    ADR_0x0112_UINT,          0x01, 0x12,  1, 0, 0,             UINT_FIELD},    // 100    2   20  0x64
        //{    ADR_0x0113_UINT,          0x01, 0x13,  1, 0, 0,             UINT_FIELD},    // 100    2   20  0x64
        //{    ADR_0x0114_UINT,          0x01, 0x14,  1, 0, 0,             UINT_FIELD},    // 100    2   20  0x64
        //{    ADR_0x0115_UINT,          0x01, 0x15,  1, 0, 0,             UINT_FIELD},    // 100    2   20  0x64
        //{    ADR_0x0116_UINT,          0x01, 0x16,  1, 0, 0,             UINT_FIELD},    // 100    2   20  0x64
        //{    ADR_0x0117_UINT,          0x01, 0x17,  1, 0, 0,             UINT_FIELD},    // 100    2   20  0x64
        //{    ADR_0x0118_UINT,          0x01, 0x18,  1, 0, 0,             UINT_FIELD},    // 100    2   20  0x64
        //{    ADR_0x0119_UINT,          0x01, 0x19,  1, 0, 0,             UINT_FIELD},    // 100    2   20  0x64
        //{    ADR_0x011A_UINT,          0x01, 0x1A,  1, 0, 0,             UINT_FIELD},    // 100    2   20  0x64
        //{    ADR_0x011B_UINT,          0x01, 0x1B,  1, 0, 0,             UINT_FIELD},    // 100    2   20  0x64
        //{    ADR_0x011C_UINT,          0x01, 0x1C,  1, 0, 0,             UINT_FIELD},    // 100    2   20  0x64
        //{    ADR_0x011D_UINT,          0x01, 0x1D,  1, 0, 0,             UINT_FIELD},    // 100    2   20  0x64
        //{    ADR_0x011E_UINT,          0x01, 0x1E,  1, 0, 0,             UINT_FIELD},    // 100    2   20  0x64
        //{    ADR_0x011F_UINT,          0x01, 0x1F,  1, 0, 0,             UINT_FIELD},    // 100    2   20  0x64
    ...
    static device_field_data_t bluetti_polling_command[] =
      {
        ...
        {FIELD_UNDEFINED, 0x01, 0x00, 0x20 ,0 , 0, TYPE_UNDEFINED},
